...
def upgrade() -> None:
    ...
    # op.execute("UPDATE tariffs SET name = jsonb_build_object('ru', name::text) WHERE name IS NOT NULL AND name::text NOT LIKE '{%}'")
    # op.execute("UPDATE servers SET name = jsonb_build_object('ru', name::text) WHERE name IS NOT NULL AND name::text NOT LIKE '{%}'")
